// The bare bounds of LGraphCanvas's fitViewToSelectionAnimated/animateToBounds function and supporting types

export declare function createBounds(objects: Iterable<{
    boundingRect: ReadOnlyRect;
}>, padding?: number): ReadOnlyRect | null;
